...
//        subject_list.add(new Subject1(38, "Bs", 4, true, sarrays, 2));
    ...
    public static List<Subject1> getSubjects(){
     ...
     public static List<Subject1> getSubjectsf3v(){
      ...
      public static List<Subject1> getSubjectsDoubled(){
        List<Subject1> subject_list = new ArrayList<>();
        String[] sarrays = {};
        
        //form 1 & 2
        subject_list.add(new Subject1(1, "Eng", 5, false, sarrays, 1, 0));
        subject_list.add(new Subject1(2, "Kis", 5, false, sarrays, 1 , 0));
        subject_list.add(new Subject1(3, "Mat", 6, true, sarrays, 1 , 1));
        subject_list.add(new Subject1(4, "Chem", 4, true, sarrays, 1 , 1));
        subject_list.add(new Subject1(5, "Bio", 4, true, sarrays, 1 , 1));
        subject_list.add(new Subject1(6, "Phy", 4, true, sarrays, 1 , 1));
        subject_list.add(new Subject1(7, "Hist", 3, false, sarrays, 1 , 0));
        subject_list.add(new Subject1(8, "Cre", 3, false, sarrays, 1 , 0));
        subject_list.add(new Subject1(9, "Geo", 3, false, sarrays, 1 , 0));
        subject_list.add(new Subject1(10, "Agr_Hsc_Bs_comp", 4, false, sarrays, 1 , 0));
        
         //form 3 & 4
        subject_list.add(new Subject1(11, "Eng", 7, true, sarrays, 1 , 2));
        subject_list.add(new Subject1(12, "Kis", 7, true, sarrays, 1 , 2));
        subject_list.add(new Subject1(13, "Mat", 7, true, sarrays, 1 , 2));
        subject_list.add(new Subject1(14, "Chem", 4, true, sarrays, 1 , 1));
        subject_list.add(new Subject1(15, "Bio_Phy", 4, true, sarrays, 1 , 1));
        subject_list.add(new Subject1(16, "Hist_Geo", 4, false, sarrays, 1 , 0));
        subject_list.add(new Subject1(17, "Cre", 4, false, sarrays, 1 , 0));
        subject_list.add(new Subject1(18, "Agr_Hsc_Bs_comp", 4, false, sarrays, 1 , 0));
        
        return subject_list;
    }
      
      
       public static List<Subject1> getSubjectsf3vDoubled(){
        List<Subject1> subject_list = new ArrayList<>();
        String[] sarrays = {};
